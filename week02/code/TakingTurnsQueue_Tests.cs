...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: the AddPerson method always insert the person at index 0
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: there was no case to handle the 0 or negative number in the takingTurnsQueue
